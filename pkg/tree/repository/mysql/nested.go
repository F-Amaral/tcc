...
func NewNested(config *viper.Viper) (repositories.Tree, error) {
...
func (p nested) Save(_ context.Context, node *entity.Node) apierrors.ApiError {
...
func (p nested) GetById(_ context.Context, id string) (*entity.Node, apierrors.ApiError) {
...
func (p nested) GetTree(_ context.Context, rootId string) (*entity.Node, apierrors.ApiError) {
	sql := `
